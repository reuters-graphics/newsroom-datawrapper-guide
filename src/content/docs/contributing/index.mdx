...
This site is built using [Starlight](https://starlight.astro.build/) and the [Astro](https://astro.build/) web framework. But the minimum you need to know is basic [markdown](https://www.markdownguide.org/basic-syntax/) syntax to write documentation.
